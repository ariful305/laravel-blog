        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="card-body">
                ...
                <td>{{ $key+1 }}  </td>
                <td><img src="{{asset($iteam->image)}}" width="100px" ></td>
                <td>{{$iteam->title}}</td>
                <td>{{ Str::limit($iteam->description,150,$end='.......')}}</td>
                <td>{{$iteam->slug}}</td>
                ...
                <td>
                <a class="btn btn-info btn-sm" href="{{ route('post.edit',[$iteam->id])}}" >
                ...
                <td>
                    <form action="{{ route('post.destroy',[$iteam->id]) }}" method="POST">
                        ...
                        @method('DELETE')
                         ...
                         <button onclick="return confirm('Are you sure you want to Delete?');" class="btn btn-danger btn-sm" href="{{ route('post.destroy',[$iteam->id])}}" type="submit">
