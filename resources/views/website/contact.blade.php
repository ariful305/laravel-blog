              ...
              <div class="row">
                <div class="col-lg-8">
                  <div class="sidebar-item contact-form">
                    ...
                    <div class="content">
                      <form id="contact" action="{{ route('contacts') }}" method="post">
                        @csrf
                        @if ($errors->has(['name']))
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 col-sm-12">
                            <fieldset>
                              <input name="email" type="text" id="email" placeholder="Your email" value="{{ old('email')}}">
                            </fieldset>
                          </div>
                          <div class="col-md-12 col-sm-12">
                            <fieldset>
                              <input name="subject" type="text" id="subject" placeholder="Subject" value="{{ old('subject')}}">
                            </fieldset>
                          </div>
                          <div class="col-lg-12">
                            <fieldset>
